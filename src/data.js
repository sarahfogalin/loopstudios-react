...
import mobileSoccer from "./images/mobile/image-soccer-team.jpg";

import desktopGrid from "./images/desktop/image-grid.jpg";
import mobileGrid from "./images/mobile/image-grid.jpg";

import desktopUpAbove from "./images/desktop/image-from-above.jpg";
import mobileUpAbove from "./images/mobile/image-from-above.jpg";
...
import desktopCurisity from "./images/desktop/image-curiosity.jpg";
...
const creationsData = [
  {
    lineOne: "DEEP",
    lineTwo: "EARTH",
    desktopSrc: desktopEarth,
    mobileSrc: mobileEarth,
  },
  {
    lineOne: "NIGHT",
    lineTwo: "ARCADE",
    desktopSrc: desktopArcade,
    mobileSrc: mobileArcade,
  },
  {
    lineOne: "SOCCER",
    lineTwo: "TEAM VR",
    desktopSrc: desktopSoccer,
    mobileSrc: mobileSoccer,
  },
  {
    lineOne: "THE",
    lineTwo: "GRID",
    desktopSrc: desktopGrid,
    mobileSrc: mobileGrid,
  },
  {
    lineOne: "FROM UP",
    lineTwo: "ABOVE VR",
    desktopSrc: desktopUpAbove,
    mobileSrc: mobileUpAbove,
  },
  {
    lineOne: "POCKET",
    lineTwo: "BOREALIS",
    desktopSrc: desktopPocket,
    mobileSrc: mobilePocket,
  },
  {
    lineOne: "THE",
    lineTwo: "CURIOSITY",
    desktopSrc: desktopCurisity,
    mobileSrc: mobileCuriosity,
  },
  {
    lineOne: "MAKE IT",
    lineTwo: "FISHEYE",
    desktopSrc: desktopFisheye,
    mobileSrc: mobileFisheye,
  },
];
